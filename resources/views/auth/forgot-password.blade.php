...
<head>
    ...
    <title>Lupa Password - Learning System</title>
...
<body class="bg-slate-100 min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        ...
        <!-- Pesan Status (tautan reset berhasil dikirim) -->
        @if (session('status'))
        ...
        <!-- Form permintaan tautan reset (Fortify: route 'password.email') -->
        ...
        <p class="text-center text-sm text-slate-600 mt-6">
            Ingat password Anda? <a href="{{ route('login') }}" class="text-indigo-600 font-medium hover:underline">Kembali ke halaman masuk</a>
        </p>
    </div>
</body>
</html>
